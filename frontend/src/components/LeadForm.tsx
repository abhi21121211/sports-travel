...
import { submitLead, getEvents } from '@/lib/api'
...
export default function LeadForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.package) {
      newErrors.package = 'Please select an event.'
      valid = false
    }
    ...
    try {
      const leadData = {
        ...
        event: formData.package, // This is now the Event ID
        ...
        <form className="modern-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="package">
              ...
              Event of Interest <span className="required">*</span>
            </label>
            <select
              id="package"
              name="package"
